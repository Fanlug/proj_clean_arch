...
mixin _$HomePageState on HomePageStateBase, Store {
  late final _$dayAtom = Atom(name: 'HomePageStateBase.day', context: context);
  ...
  late final _$isLoadingAtom =
      Atom(name: 'HomePageStateBase.isLoading', context: context);
  ...
  late final _$getDayAsyncAction =
      AsyncAction('HomePageStateBase.getDay', context: context);
